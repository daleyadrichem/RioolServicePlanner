...
export const api = {
  ...
  updateTechnicianSimulatorState: (technicianId, payload) => request(`/simulator/technicians/${encodeURIComponent(technicianId)}`, { method: 'PATCH', body: JSON.stringify(payload) }),
